...
export default function ServicesSection() {
  ...
  return (
    <section
      ...
      style={{ background: 'var(--section-services-bg, var(--background))' }}
    >
      <div className="container-width section-padding">
        ...
        >
          <h2 className="text-section text-2xl sm:text-3xl md:text-4xl">
            {t('services.title')}
          </h2>
        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="glass-subtle p-6 sm:p-8 rounded-2xl hover-lift group"
              whileHover={{ y: -5, scale: 1.02 }}
            >
              <motion.div
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl gradient-accent flex items-center justify-center mb-4 sm:mb-6"
